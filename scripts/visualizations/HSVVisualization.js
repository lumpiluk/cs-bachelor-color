...
import HSV_CYLINDER_SHADER from "../../_shaders/hsv-cylinder-fragment.glsl" with { type: "text" };
import HSV_CUBE_SHADER from "../../_shaders/hsv-cube-fragment.glsl" with { type: "text" };
...
export class HSVVisualization extends Visualization {
    constructor($container) {
        ...
        this.pivot.rotation.set(-0.481662946889053, 0.35635976369078254, 0, "YXZ"); // YXZ
